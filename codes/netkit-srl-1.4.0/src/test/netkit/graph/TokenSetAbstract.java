 ...
 * @version 1.0
 */
public abstract class TokenSetAbstract extends TestCase
{
    public TokenSetAbstract(String name)
    {
        super(name);
    }
    ...
    {
        return new TestSuite(TokenSetAbstract.class);
    }
}
